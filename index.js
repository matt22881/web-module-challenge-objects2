...
function createMenuItem(vari, name, price, category){
...
createMenuItem('sos',"S.O.S.", 1.5, 'Breakfast')
...
reviews.unshift({
  name:'Matt',
  rating:1,
  feedback:"Only thing worse than the food was the diarrhea .  Won't be back"
});
...
console.log(carMaker(10).drive(20));
